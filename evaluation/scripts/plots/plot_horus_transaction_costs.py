...
labels           = ['RE', 'AC', 'IO', 'UE']
smartshield_size = [df['reentrancy']['smartshield']['gas_increase'], df['parity_wallet_hack_1']['smartshield']['gas_increase'], df['integer_overflow']['smartshield']['gas_increase'], df['unhandled_exception']['smartshield']['gas_increase']]
smartshield_size = [0,0,60,38]
elysium_size     = [df['reentrancy']['elysium']['gas_increase'], df['parity_wallet_hack_1']['elysium']['gas_increase'], df['integer_overflow']['elysium']['gas_increase'], df['unhandled_exception']['elysium']['gas_increase']]
elysium_size     = [25838,0,32,23]
...
def autolabel(rects):
    for rect in rects:
        height = rect.get_height()
        if height > 0:
            ax.annotate(r'{:,}'.format(int(height)),
...
plt.savefig("horus_transaction_costs.pdf", dpi=1000, bbox_inches='tight')
